...
struct modint {
    ...
    inline modint<MOD_VAL> operator+(modint<MOD_VAL> other) const {
        int32_t c = this->value + other.value;
        return modint<MOD_VAL>(c >= MOD_VAL ? c - MOD_VAL : c);
    }

    inline modint<MOD_VAL> operator-(modint<MOD_VAL> other) const {
        int32_t c = this->value - other.value;
        return modint<MOD_VAL>(c < 0 ? c + MOD_VAL : c);
    }

    inline modint<MOD_VAL> operator*(modint<MOD_VAL> other) const {
        int32_t c = (int64_t)this->value * other.value % MOD_VAL;
        return modint<MOD_VAL>(c < 0 ? c + MOD_VAL : c);
    }

    inline modint<MOD_VAL>& operator+=(modint<MOD_VAL> other) {
        this->value += other.value;
        if (this->value >= MOD_VAL) this->value -= MOD_VAL;
        return *this;
    }

    inline modint<MOD_VAL>& operator-=(modint<MOD_VAL> other) {
        this->value -= other.value;
        if (this->value < 0) this->value += MOD_VAL;
        return *this;
    }

    inline modint<MOD_VAL>& operator*=(modint<MOD_VAL> other) {
        this->value = (int64_t)this->value * other.value % MOD_VAL;
        if (this->value < 0) this->value += MOD_VAL;
        return *this;
    }

    inline modint<MOD_VAL> operator-() const { return modint<MOD_VAL>(this->value ? MOD_VAL - this->value : 0); }

    modint<MOD_VAL> pow(uint64_t k) const {
        modint<MOD_VAL> x = *this, y = 1;
        for (; k; k >>= 1) {
            if (k & 1) y *= x;
            x *= x;
        }
    ...
    modint<MOD_VAL> inv() const { return pow(MOD_VAL - 2); }  // MOD_VAL must be a prime

    inline modint<MOD_VAL> operator/(modint<MOD_VAL> other) const { return *this * other.inv(); }

    inline modint<MOD_VAL> operator/=(modint<MOD_VAL> other) { return *this *= other.inv(); }

    inline bool operator==(modint<MOD_VAL> other) const { return value == other.value; }

    inline bool operator!=(modint<MOD_VAL> other) const { return value != other.value; }
};

template <int32_t MOD_VAL>
modint<MOD_VAL> operator*(int64_t value, modint<MOD_VAL> n) {
    return modint<MOD_VAL>(value) * n;
}

template <int32_t MOD_VAL>
modint<MOD_VAL> operator*(int32_t value, modint<MOD_VAL> n) {
    return modint<MOD_VAL>(value % MOD_VAL) * n;
}

template <int32_t MOD_VAL>
ostream& operator<<(ostream& out, modint<MOD_VAL> n) {
    return out << n.value;
}
