// Topic: Prime Counting Function - [Computes pi(x) using Meissel-Lehmer algorithm]
#include "../../../core.h"

/*
 * Description: The Prime Counting Function efficiently computes the exact number of primes up
 *   to a large integer limit using advanced combinatorial methods. Commonly applied
 *   in large-scale prime distribution problems.
 * This mathematical template provides an efficient implementation for Prime Counting Function.
 * It is commonly used in Advanced Number Theory problems.
 *
 * Usage:
 * PrimeCountingFunction_Algorithm solver;
 * auto result = solver.sieve(...);
 */
// Time Complexity: O(N^(3/4))
// Space Complexity: O(sqrt(N))
struct PrimeCountingFunction_Algorithm {
    const int N = 3e5 + 9;
