// Topic: Fastest Prime Factorization - [Optimized Pollard Rho for fast factorization]
#include <cassert>

#include "../../../core.h"

/*
 * Description: Uses highly optimized algorithms like Pollard's rho paired with Miller-Rabin
 *   primality testing to factorize large integers quickly. Essential for
 *   cryptography and advanced number theory tasks.
 ...
 * Fastest Prime Factorization. It is commonly used in Advanced Number Theory problems.
 *
 * Usage:
 * PrimeFactorizationFastest_Algorithm solver;
 * auto result = solver.factor(...);
 */
// Time Complexity: O(N^(1/4))
// Space Complexity: O(1)
struct PrimeFactorizationFastest_Algorithm {
