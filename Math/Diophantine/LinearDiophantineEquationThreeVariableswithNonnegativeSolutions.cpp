// Topic: Linear Diophantine 3 Variables - [Solves ax + by + cz = d with non-negative constraints]
#include "../../../core.h"

/*
 * Description: Linear Diophantine Equation with three variables is an algorithmic technique
 *   that solves ax + by + cz = d for non-negative integers x, y, z. It is used when
 *   finding if a quantity can be represented as a combination of three specific
 *   items.
 * This mathematical template provides an efficient implementation for Linear Diophantine 3 Variables.
 * It is commonly used in Advanced Number Theory problems.
 *
 * Usage:
 * LinearDiophantineEquationThreeVariableswithNonnegativeSolutions_Algorithm solver;
 * auto result = solver.extended_euclid(...);
 */
// Time Complexity: O(log(min(a, b)))
// Space Complexity: O(1)
struct LinearDiophantineEquationThreeVariableswithNonnegativeSolutions_Algorithm {
    using T = __int128;
