/*
 * Topic: DominatorTree
 * Description: Builds a Dominator Tree for a directed graph, where a node u dominates v if
 *   every path from the source to v must pass through u.
 * Usage:
 *    DominatorTree solver(N);
 *    solver.add_edge(u, v);
 *    solver.build();
 */
#include "../../../core.h"
